...
const GroupCallContent = ({ 
  ...
  <img 
    src={p?.image || p?.photoURL || p?.avatar || getAuth().currentUser?.photoURL || ''} 
    alt="" 
  ...
  <span className="text-xs font-black text-zinc-400">
    {(p?.name || p?.userId || 'U').charAt(0).toUpperCase()}
      ...
      {isPCamEnabled ? (
        ...
        <div className="w-full h-full flex flex-col items-center justify-center bg-zinc-900/80 relative">
          {/* Center Avatar */}
          <div className="relative">
